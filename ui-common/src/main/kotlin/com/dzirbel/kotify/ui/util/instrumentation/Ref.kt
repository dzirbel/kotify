...
internal operator fun <T> Ref<T>.getValue(thisRef: Any?, property: KProperty<*>): T = this.value

internal operator fun <T> Ref<T>.setValue(thisRef: Any?, property: KProperty<*>, value: T) {
    this.value = value
}
